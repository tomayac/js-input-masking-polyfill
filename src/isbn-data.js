...
// node_modules/isbn3/lib/groups.js
var require_groups = __commonJS({
  "node_modules/isbn3/lib/groups.js"(exports, module) {
    module.exports = {
      "978-0": {
...
// node_modules/isbn3/lib/calculate_check_digit.js
var require_calculate_check_digit = __commonJS({
  "node_modules/isbn3/lib/calculate_check_digit.js"(exports, module) {
    module.exports = (isbn) => {
      let check = 0;
      if (isbn.length === 9) {
        for (let n = 0; n < 9; n += 1) {
...
// node_modules/isbn3/lib/fill.js
var require_fill = __commonJS({
  "node_modules/isbn3/lib/fill.js"(exports, module) {
    var groups = require_groups();
    var calculateCheckDigit = require_calculate_check_digit();
...
// node_modules/isbn3/lib/get_group.js
var require_get_group = __commonJS({
  "node_modules/isbn3/lib/get_group.js"(exports, module) {
    var groups = require_groups();
    var groupsMap = {};
...
// node_modules/isbn3/lib/split_isbn_parts.js
var require_split_isbn_parts = __commonJS({
  "node_modules/isbn3/lib/split_isbn_parts.js"(exports, module) {
    var getGroup = require_get_group();
    module.exports = (isbn) => {
      if (isbn.length === 10)
        isbn = "978" + isbn;
      if (isbn.length === 13)
        return findValidCodes(isbn);
      return null;
    };
    var findValidCodes = (isbn13) => {
...
// node_modules/isbn3/lib/parse.js
var require_parse = __commonJS({
  "node_modules/isbn3/lib/parse.js"(exports, module) {
    var fill = require_fill();
    var splitIsbnParts = require_split_isbn_parts();
...
// node_modules/isbn3/lib/audit.js
var require_audit = __commonJS({
  "node_modules/isbn3/lib/audit.js"(exports, module) {
    ...
    var considerAltPrefix = (normalizedIsbn, altPrefix, clues) => {
    ...
    var guessPrefixFromChecksum = (normalizedIsbn, altPrefix, clues) => {
    ...
    var normalize = (input) => input.replace(/[^\dX]/g, "");
  }
});

// node_modules/isbn3/isbn.js
var require_isbn = __commonJS({
  "node_modules/isbn3/isbn.js"(exports, module) {
    var parse = require_parse();
    ...
    module.exports = {
      ...
      groups: require_groups()
    };
  }
});

// dep:isbn3
var isbn3_default = require_isbn();
export {
  isbn3_default as default
};